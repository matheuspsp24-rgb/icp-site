// Workflow GIT:
// Fazer o Fork.
// Criar a branch: git checkout -b feature/pagina-doar-nomedoaluno.
// Desenvolver apenas dentro do arquivo src/pages/Doar.jsx.
...
const Doar = () => (
    <Template title="Como Ajudar / Doações">
