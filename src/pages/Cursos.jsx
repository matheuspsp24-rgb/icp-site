// Workflow GIT:
// Fazer o Fork.
// Criar a branch: git checkout -b feature/pagina-cursos-nomedoaluno.
// Desenvolver apenas dentro do arquivo src/pages/Cursos.jsx.
...
const Cursos = () => (
    <Template title="Cursos Profissionalizantes">
